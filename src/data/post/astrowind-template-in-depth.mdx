...
title: Cognivac template in depth
excerpt: While easy to get started, Cognivac is quite complex internally.  This page provides documentation on some of the more intricate parts.
